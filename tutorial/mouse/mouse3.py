...
# définir une classe de formes avec rect, color, épaisseur
class Shape:
...
#cérer des attribut de cet objet
...
while running:
    ...
    pygame.draw.rect(screen, BLUE, current_shape.rect, current_shape.width)
