...
txt = font.render(sysfont, True, RED)
rect2 = txt.get_rect()
pygame.draw.rect(txt, BLUE, rect, 1)

font1 = pygame.font.SysFont('welcome to editor', 72)
txt1 = font1.render('welcome to editor', True, BLUE)
...
# Définir une classe shape (avec rect, couleur et épaisseur)
class Shape:
...
while running:
    for event in pygame.event.get():
        ...
        # affichage (écran, rectangle, image, texte)
        screen.fill(GRAY)
        for s in shapes[1:]: # "1:" index 1 jusqu'à la fin
            s.draw()
        screen.blit(img, rect)
        screen.blit(txt1, (30, 0))
